...
//        [self insertText:emotion.cht];
        ...
        [attributedText addAttribute:NSForegroundColorAttributeName value:[UIColor colorWithRed:168/255.0f green:168/255.0f blue:168/255.0f alpha:1.0] range:NSMakeRange(0, attributedText.length)];
