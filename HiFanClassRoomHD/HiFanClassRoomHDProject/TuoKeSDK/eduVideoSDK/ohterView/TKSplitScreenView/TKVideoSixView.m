...
- (void)setVideoSmallViewArray:(NSMutableArray *)videoSmallViewArray{
    ...
    fourView.frame = CGRectMake(0, videoBackHeight/2, videoBackWidth/3, videoBackHeight/2);
    
    
    TKVideoSmallView *fiveView =(TKVideoSmallView *) videoSmallViewArray[4];
    [self addSubview:fiveView];
    fiveView.frame = CGRectMake(videoBackWidth/3, videoBackHeight/2, videoBackWidth/3, videoBackHeight/2);
    
    
    TKVideoSmallView *sixView =(TKVideoSmallView *) videoSmallViewArray[5];
    [self addSubview:sixView];
    sixView.frame = CGRectMake(videoBackWidth/3*2, videoBackHeight/2, videoBackWidth/3, videoBackHeight/2);
