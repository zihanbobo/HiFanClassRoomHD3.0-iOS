...
@implementation TKVideoFourView
- (void)setVideoSmallViewArray:(NSMutableArray *)videoSmallViewArray{
    ...
    threeView.frame = CGRectMake(0, videoBackHeight/2, videoBackWidth/2, videoBackHeight/2);
    
    
    TKVideoSmallView *fourView =(TKVideoSmallView *) videoSmallViewArray[3];
    [self addSubview:fourView];
    fourView.frame = CGRectMake(videoBackWidth/2, videoBackHeight/2, videoBackWidth/2, videoBackHeight/2);
}
/*
