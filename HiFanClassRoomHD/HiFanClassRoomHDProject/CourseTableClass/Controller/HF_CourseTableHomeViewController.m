//
//  HF_CourseTableHomeViewController.m
//  HiFanClassRoomHD
//
...
#import "HF_CourseTableHomeViewController.h"

@interface HF_CourseTableHomeViewController () <UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView; //tableView
@end

@implementation HF_CourseTableHomeViewController
...
- (void)viewDidLoad {
    ...
    self.navBigLabel.text = @"Course table";
